...
15. **Semantic Versioning (SemVer)** *(Baru)*: Pelacakan versi bot secara global menggunakan format SemVer (versi saat ini: `1.7.81`). Dikelola melalui file root `VERSION` dan disinkronkan secara dinamis ke seluruh konfigurasi bot.
